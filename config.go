...
type Config struct {
	...
	NostrSecretKeyFile         string `envconfig:"NOSTR_PRIVKEY_FILE" default:"/etc/secrets/nostr_privkey.pem"`
	CookieSecret               string `envconfig:"COOKIE_SECRET" required:"true"`
	CookieSecretFile           string `envconfig:"COOKIE_SECRET_FILE" default:"/etc/secrets/secret.key"`
	...
	UmaVaspJwtPubKeySecretFile string `envconfig:"UMA_VASP_JWT_PUBKEY_SECRET_FILE" default:"/etc/secrets/jwt_pubkey.pub"`
